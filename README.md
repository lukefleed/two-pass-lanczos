...
The test suite validates mathematical properties of the Lanczos implementations against analytically computed ground truth solutions. For this test we use the datasets downloaded from the [CommaLab MCF repository](https://commalab.di.unipi.it/datasets/mcf/).

Particolarly, we test _all_ the instances in the directories:
