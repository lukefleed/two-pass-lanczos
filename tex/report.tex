...
\title{A Memory and Cache Efficient Two-Pass Lanczos Algorithm}
...
\begin{figure}[h!]
    ...
    \caption{Wall-clock time vs. iteration count for a dense matrix ($n=10000$). This time we don't need to use the log scale on the y-axis, as the times are much larger.}
