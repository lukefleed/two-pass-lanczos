...
mod tests {
    ...
    fn test_lanczos_standard_produces_correct_dimensions() {
        ...
        let result = lanczos_standard(&a.as_ref(), b.as_ref(), k, None).unwrap();
    ...
    fn test_one_pass_and_pass_one_produce_same_tridiagonal() {
        ...
        let standard_result = lanczos_standard(&a.as_ref(), b.as_ref(), k, None).unwrap();
    ...
    fn test_lanczos_relation_holds() {
        ...
        let result_k = lanczos_standard(&a.as_ref(), b.as_ref(), k, None).unwrap();
    ...
    fn test_zero_vector_input_returns_error() {
        ...
        assert!(lanczos_standard(&a, b.as_ref(), 2, None).is_err());
