...
//!! modified by A. Frangioni on October 9, 2021 to fix an issue with the
//!! "portable" random generator (see random.c) and do away with some
//!! pesky warnings about ints being used in place of longs
...
PRIVATE void sort_skeleton(long);	/* sorts skeleton chains */
